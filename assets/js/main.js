...
(function ($) {
  ...
  var tmPk = {
    ...
    methods: function (e) {
      ...
      tmPk.tpm_mobileMenuActive();
      tmPk.stickyToTop();
      tmPk.tmpcustomAnimation().init(); // Call init method
      tmPk.popupMobileMenu();
      tmPk.preloaderWithBannerActivation();
      tmPk.animationOnHover();
      tmPk.odoMeter();
    ...
    serviceWidget: function () {
      function serviceAnimation() {
        var $servicesWidget = $(".services-widget");
        if (!$servicesWidget.length) return; // Guard
    ...
    swiperJs: function () {
      ...
      $(document).ready(function () {
        ...
        new Swiper(".swiper-testimonials-one", {
          slidesPerView: 1,
          spaceBetween: 30,
          navigation: {
            nextEl: ".project-swiper-button-next",
    ...
    stickyHeader: function (e) {
      ...
      if ($(window).width() < 1500) {
        $(".tmp-sticky-top-banner").css({ top: 150 });
      } else {
        $(".tmp-sticky-top-banner").css({ top: 200 });
      }
    },
    ...
    fonklsAnimation: function () {
      ...
      var mySplitText = new SplitText(".end", { type: "words,chars" });
    ...
    stickyToTop: function (e) {
      $(".tmp-sticky-top").css({ top: 25 });
    },

    preloaderWithBannerActivation: function () {
      // Guard for GSAP and SplitText
      if (typeof gsap === "undefined" || typeof SplitText === "undefined") return;
      gsap.registerPlugin(SplitText, ScrollTrigger);

      document.addEventListener("DOMContentLoaded", function () {
        var heroTitles = document.querySelectorAll(".tmp-title-split");
        var heroSubtitles = document.querySelectorAll(".hero__sub-title");

        heroTitles.forEach(function (title, index) {
          var subtitle = heroSubtitles[index];

          var splitTitle = new SplitText(title, { type: "chars" });
          var splitSubtitle = subtitle
            ? new SplitText(subtitle, { type: "chars words" })
            : null;
        ...
        var heroTitles2 = document.querySelectorAll(".tmp-title-split-2");
        heroTitles2.forEach(function (title, index) {
          var subtitle = heroSubtitles[index];
    ...
    animationOnHover: function () {
      var cards = document.querySelectorAll(".tmponhover");
      cards.forEach(function (tmpOnHover) {
        tmpOnHover.onmousemove = function (e) {
          var rect = tmpOnHover.getBoundingClientRect();
    ...
    tiltAnimation: function () {
      ...
      $(document).ready(function () {
        var container = document.querySelector(".tilt-container");
        var card = document.querySelector(".tilt-card");
        if (container && card) {
          container.addEventListener("mousemove", function (e) {
            var xPos = (window.innerWidth / 2 - e.pageX) / 80;
            var yPos = (window.innerHeight / 2 - e.pageY) / 80;
            card.style.transform = "rotateX(" + yPos + "deg) rotateY(" + xPos + "deg)";
          });
      ...
      if (document.querySelector(".inv-title-animation-wrap")) {
        var animatedTextElements = document.querySelectorAll(".inv-title-animation-wrap");
